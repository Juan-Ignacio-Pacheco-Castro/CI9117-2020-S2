...
* Importe en su programa los archivos mapper.h y mapper.c dados por el profesor. Estos archivos contienen toda la información referente a las especies de Pokémon, ataques y tipos requeridos para el proyecto. Dichos archivos no requieren modificación y puede hacer uso de los métodos definidos en el encabezado (Puede realizar modificaciones si lo considera necesario).
